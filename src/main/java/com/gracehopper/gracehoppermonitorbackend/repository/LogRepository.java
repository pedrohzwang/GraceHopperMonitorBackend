...
public interface LogRepository extends JpaRepository<Log, Integer> {
    ...
    @Query(value = "SELECT * FROM log WHERE id_usuario = ?1 and DATE_FORMAT(dt_log, \"%Y-%m-%d\") = \'' ?2 \''", nativeQuery = true)
    List<Log> getLogsByUserDate(Integer userId, @Param("logDate") String logDate);
